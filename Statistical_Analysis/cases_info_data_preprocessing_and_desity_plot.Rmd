...
ct_info_cases_data = ct_info_data %>% 
  ...
  mutate(estimate_cases1 = cases1*POPULATION/county_pop,
         ...
         estimate_cases1_density = estimate_cases1/POPULATION,
         estimate_cases2_density = estimate_cases2/POPULATION,
         estimate_cases3_density = estimate_cases3/POPULATION,
         estimate_cases4_density = estimate_cases4/POPULATION,
